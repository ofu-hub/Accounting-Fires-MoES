    ...
    internal class MainWindowViewModel : ViewModelBase
    {
        ...
        public void DeleteFile()
        {
            ...
            if (SelectedFileRep == null)
                MessageBox.Show("Выберите отчет из списка 'Отчеты по пожарам'!", caption, MessageBoxButton.OK, MessageBoxImage.Warning, MessageBoxResult.Yes);
            else
            {
        ...
        public void GeneratePDF()
        {
            ...
            else
            {
                ...
                string messageBoxText = "Отчет сформирован в PDF-файл рядом с программой.\nЕго имя: Отчет_Ид№" + SelectedFileRep.Id.ToString() + ".pdf";
